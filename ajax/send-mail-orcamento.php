<?php
    ...
    $tipoTransporte = $_POST['tipo-opcao']; //Field Select
    $quantidadePessoas = $_POST['quantidade']; //Input Number
    ...
    try {
        ...
        <b>Tipo de Transporte: </b>$tipoTransporte<br>
        <b>Quantidade de pessoas: </b>$quantidadePessoas";
